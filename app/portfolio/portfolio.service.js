        ...
        execute: function() {
            PortfolioService = (function () {
                ...
                PortfolioService.prototype.getPortfolio = function () {
                    return this._http.get('http://' + myGlobals.srv + '/ws/service/portfolio.php').map(function (responseData) {
                        return responseData.json();
                    });
                };
                PortfolioService.prototype.getPortfolioValues = function () {
                    return this._http.get('http://' + myGlobals.srv + '/ws/service/portfolioValue.php').map(function (responseData) {
                        return responseData.json();
                    });
                };
